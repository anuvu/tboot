...
int der_encode_asn1_length(unsigned long len, unsigned char *out, unsigned long *outlen)
{
   ...
   if (out == NULL) {
      ...
      if (len < 128) {
         ...
         out[x++] = 0x85;
         out[x++] = (unsigned char)((((unsigned long long)len)>>32ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>24ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>16ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>8ULL)&255);
         out[x++] = (unsigned char)(len&255);
      } else if (len <= 0xffffffffffffULL) {
         out[x++] = 0x86;
         out[x++] = (unsigned char)((((unsigned long long)len)>>40ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>32ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>24ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>16ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>8ULL)&255);
         ...
         out[x++] = 0x87;
         out[x++] = (unsigned char)((((unsigned long long)len)>>48ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>40ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>32ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>24ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>16ULL)&255);
         ...
         out[x++] = 0x88;
         out[x++] = (unsigned char)((((unsigned long long)len)>>56ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>48ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>40ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>32ULL)&255);
         out[x++] = (unsigned char)((((unsigned long long)len)>>24ULL)&255);
